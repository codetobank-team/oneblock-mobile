...
class ENProvider extends I18nProvider {
  ...
  @override
  String getTitleText(Options options) {
    String s = options.maxSelected > 1 ? "s" : "";
    return options.pickType == PickType.onlyVideo
        ? "Choose Video"
        : "Choose Photo$s";
  }
  ...
  @override
  String getSureText(Options options, int currentCount) {
    return "SELECT ($currentCount/${options.maxSelected})";
  }
  ...
  @override
  String getMaxTipText(Options options) {
    return "Select ${options.maxSelected} ${options.pickType == PickType.onlyVideo ? "video" : "pictures"} at most";
  }

  @override
  String getAllGalleryText(Options options) {
    return options.pickType == PickType.onlyVideo ? "All Videos" : "All Photos";
  }
